...
== NeuVector Installation Using Edge Image Builder
...
The NeuVector EIB Definition looks like:
[,console]
----
apiVersion: 1.0
image:
...
We will also create a SUSE Edge optimizied Helm values file for NeuVector:
[,shell]
----
